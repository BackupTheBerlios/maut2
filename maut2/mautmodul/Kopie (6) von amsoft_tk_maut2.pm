...
sub get_strecke
{
  ...
  {
		print "---------------------------------------------------\n";
		print "--------------- in REKURSION $rek_zaehler --------------------\n";
		print "---------------------------------------------------\n";
	  ...
	  else
	  {
	    ...
	    print "--- BAB-Nr. fuer neue Suche diesmal $bab_such_von\n";
	    ...
	    for (my $i=0; $i<$#daten; $i++)
	    {
          ...
          $knz_treffer = 0;
	        ...
	        # 3. und für jeden Übergang get_strecke !REKURSIV! aufrufen
	    if ($knz_treffer == 0)
	    {
	      print "--- Suchziel liegt nicht auf der BAB$bab_such_von\n";
        ...
        print "--- BAB-Nr:$bab_such_von von Such-Liste entfernt\n";
	      ...
	      print "--- Uebergaenge auf der BAB $bab_such_von: \n";
	      ...
	      {
          #print "---$uebergaenge[$k]---\n";
          print "uebergang (vor REK): $uebergaenge[$k]\n";
          $self->get_strecke($uebergaenge[$k], $such_nach, $rek_zaehler+1);
	      }
	    }
	  }
  }
